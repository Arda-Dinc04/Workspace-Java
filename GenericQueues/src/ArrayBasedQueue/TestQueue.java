...
public class TestQueue {
    ...
    public void testEnqueue() {
        try {
            queue.enqueue(1);
            assertEquals(1, queue.arr[queue.rear]);
            queue.enqueue(4);
            assertEquals(4, queue.arr[queue.rear]);
            queue.enqueue(18);
            assertEquals(18, queue.arr[queue.rear]);
            queue.enqueue(555);
            assertEquals(555, queue.arr[queue.rear]);
            queue.enqueue(9785);
            assertEquals(9785, queue.arr[queue.rear]);
